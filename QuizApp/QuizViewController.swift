...
class QuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        bannerView.adUnitID = "ca-app-pub-4737719816861795/5784688842"
        ...
        csvArray = loadCSV(fileNmae: "quiz\(selectLevel)")
        csvArray.shuffle()
        print(csvArray)
    ...
    func loadCSV(fileNmae: String) -> [String] {
        let csvBundle = Bundle.main.path(forResource: fileNmae, ofType: "csv")!
        do {
